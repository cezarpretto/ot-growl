...
angular.module("ot-growl").run(['$templateCache', function ($templateCache) {
  "use strict";
  if ($templateCache.get('templates/growl/growl.html') === undefined) {
    $templateCache.put("templates/growl/growl.html",
      ...
      '<div class="growl-detail-link" ng-if="message.details"><a href="" ng-click="message.showDetails = !message.showDetails">Ver mais detalhes</a></div>' +
      '<div class="growl-detail" ng-if="message.showDetails" ng-bind-html="message.details.detail"></div>' +
      '</div>' +
      '</div>'
    );
  }
